...
# --- ChemMLabel Schema (as defined in the Canvas) ---
# This dictionary holds the JSON schema that defines the structure
# and validation rules for all ChemMLabel material entries.
# In a real-world application, this schema would typically be loaded
# from a separate JSON file or a centralized schema registry.
CHEMLABEL_SCHEMA = {
...
for key in CHEMLABEL_SCHEMA: print(key, CHEMLABEL_SCHEMA[key])
